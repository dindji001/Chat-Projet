...
<body>
  <div class="wrapper">
    <section class="chat-area">
      <header>
      <?php
          $user_id = mysqli_real_escape_string($conn, $_GET['groupe_id_Sortie']);
          if ($user_id) {
            $sql = mysqli_query($conn, "SELECT * FROM appartenir WHERE id_groupe = '3' AND users_id = '$user_id'");
            if (mysqli_num_rows($sql) == 0) {
               $sql2 = mysqli_query($conn, "INSERT INTO appartenir (id_groupe, users_id) VALUE ('3', '$user_id')");
        ...
        <img src="img/like.png" width="100" height="100" alt="">
        <div class="details">
        <span><?php echo $langue['datingGroup']?></span>
        </div>
      </header>
  ...
  <script src="javascript/chat-sortie.js"></script>
