<?php 
  ...
  if(!isset($_SESSION['unique_id'])){
    ...
    if ($user_id) {
      $sql = mysqli_query($conn, "SELECT * FROM appartenir WHERE id_groupe = '2' AND users_id = '$user_id'");
      if (mysqli_num_rows($sql) == 0) {
         $sql2 = mysqli_query($conn, "INSERT INTO appartenir (id_groupe, users_id) VALUE ('2', '$user_id')");
...
<body>
  <div class="wrapper">
    <section class="chat-area">
      <header>
        ...
        <div class="details">
        <span><?php echo $langue['entertainmentGroup']?></span>
        </div>
      </header>
  ...
  <script src="javascript/chat-divertissement.js"></script>
