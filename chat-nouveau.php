...
<body>
  <div class="wrapper">
    <section class="chat-area">
      ...
      <?php 
          ...
          if ($user_id) {
            $sql = mysqli_query($conn, "SELECT * FROM appartenir WHERE id_groupe = '4' AND users_id = '$user_id'");
            if (mysqli_num_rows($sql) == 0) {
               $sql2 = mysqli_query($conn, "INSERT INTO appartenir (id_groupe, users_id) VALUE ('4', '$user_id')");
        ...
        <div class="details">
        <span><?php echo $langue['newsGroup']?></span>
        </div>
      </header>
  ...
  <script src="javascript/chat-nouveau.js"></script>
